...
LOCAL_ARM_MODE := arm
LOCAL_CFLAGS    := -I$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/include -I../../include -Wall -DALLEGRO_UNSTABLE -DAMAZON_IAP -DAMAZON $(DEMO)

LOCAL_LDLIBS    := -L$(ANDROID_DIR)/$(TARGET_ARCH_ABI)/lib -L$(LOCAL_PATH)/$(TARGET_ARCH_ABI) -llog -ltgui2 libs/$(TARGET_ARCH_ABI)/liballegro_monolith.so -llua5.2 -lz -lbassmidi -lbass -lpoly2tri -lGLESv1_CM -lstdc++
