function start(this_id)
	...
	load_bitmap("misc_graphics/particles/poop_splat1.png");
	load_bitmap("misc_graphics/particles/poop_splat2.png");
	load_bitmap("misc_graphics/particles/poop_splat3.png");
end
...
function stop()
	...
	destroy_bitmap("misc_graphics/particles/poop_splat1.png");
	destroy_bitmap("misc_graphics/particles/poop_splat2.png");
	destroy_bitmap("misc_graphics/particles/poop_splat3.png");
end
