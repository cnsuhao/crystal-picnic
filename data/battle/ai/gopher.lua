function start(this_id)
	...
	load_bitmap("misc_graphics/particles/dirt_chunk.png")
	load_sample("sfx/plant_shovel.ogg", false)
end
...
function stop()
	...
	destroy_bitmap("misc_graphics/particles/dirt_chunk.png")
	destroy_sample("sfx/plant_shovel.ogg")
end
