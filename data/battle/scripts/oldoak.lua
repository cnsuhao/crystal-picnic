...
function start(level_name)
	...
	load_bitmap("misc_graphics/particles/arcorn/1.png");
	load_bitmap("misc_graphics/particles/arcorn/2.png");
	load_bitmap("misc_graphics/particles/arcorn/3.png");
	load_bitmap("misc_graphics/particles/arcorn/4.png");
	load_bitmap("misc_graphics/particles/arcorn/5.png");
	load_bitmap("misc_graphics/particles/arcorn/6.png");
	load_bitmap("misc_graphics/particles/arcorn/7.png");
	load_bitmap("misc_graphics/particles/arcorn/8.png");
	load_bitmap("misc_graphics/particles/arcorn/9.png");
	load_bitmap("misc_graphics/particles/arcorn/10.png");
	load_bitmap("misc_graphics/particles/arcorn/11.png");
	load_bitmap("misc_graphics/particles/arcorn/12.png");
	load_bitmap("misc_graphics/particles/arcorn/13.png");
	load_bitmap("misc_graphics/particles/arcorn/14.png");
	load_bitmap("misc_graphics/particles/arcorn/15.png");
	load_bitmap("misc_graphics/particles/arcorn/16.png");
	wolf_anim = load_animation_set("battle/entities/wolf");
end

function stop()
	destroy_sample("sfx/rumble.ogg")
	destroy_bitmap("misc_graphics/particles/arcorn/1.png");
	destroy_bitmap("misc_graphics/particles/arcorn/2.png");
	destroy_bitmap("misc_graphics/particles/arcorn/3.png");
	destroy_bitmap("misc_graphics/particles/arcorn/4.png");
	destroy_bitmap("misc_graphics/particles/arcorn/5.png");
	destroy_bitmap("misc_graphics/particles/arcorn/6.png");
	destroy_bitmap("misc_graphics/particles/arcorn/7.png");
	destroy_bitmap("misc_graphics/particles/arcorn/8.png");
	destroy_bitmap("misc_graphics/particles/arcorn/9.png");
	destroy_bitmap("misc_graphics/particles/arcorn/10.png");
	destroy_bitmap("misc_graphics/particles/arcorn/11.png");
	destroy_bitmap("misc_graphics/particles/arcorn/12.png");
	destroy_bitmap("misc_graphics/particles/arcorn/13.png");
	destroy_bitmap("misc_graphics/particles/arcorn/14.png");
	destroy_bitmap("misc_graphics/particles/arcorn/15.png");
	destroy_bitmap("misc_graphics/particles/arcorn/16.png");
	destroy_animation_set(wolf_anim)
end
