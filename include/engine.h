...
public:
	...
	void maybe_resume_music();

	ALLEGRO_USTR *get_entire_translation();

	void switch_mouse_out();
	void switch_mouse_in();

#ifdef ALLEGRO_IPHONE
	void show_trophy(); // shows a trophy since old iOS doesn't show anything for achievements
#endif
...
protected:
	...
	ALLEGRO_USTR *entire_translation;
