...
{
	General::Point<float> min1(FLT_MAX, FLT_MAX);
	General::Point<float> max1(-FLT_MAX, -FLT_MAX);
	General::Point<float> min2(FLT_MAX, FLT_MAX);
	General::Point<float> max2(-FLT_MAX, -FLT_MAX);
	...
	return checkcoll_box_box(
		General::Point<float>(topleft1.x+min1.x, topleft1.y+min1.y),
		General::Point<float>(topleft1.x+max1.x, topleft1.y+max1.y),
		General::Point<float>(topleft2.x+min2.x, topleft2.y+min2.y),
		General::Point<float>(topleft2.x+max2.x, topleft2.y+max2.y)
	);
	*/
